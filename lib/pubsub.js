...
exports.init = function(config, logger) {
    ...
    pub = redis.createClient((config.redis.port || 6379), config.host, config.clientOpts);
    sub = redis.createClient((config.redis.port || 6379), config.host, config.clientOpts);
